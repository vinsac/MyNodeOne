...
#
# Usage:
#   ./scripts/utils/check-prerequisites.sh vps <control-plane-ip> [ssh-user]
#   ./scripts/utils/check-prerequisites.sh management <control-plane-ip> [ssh-user]
#   ./scripts/utils/check-prerequisites.sh control-plane
#
# Examples:
#   ./scripts/utils/check-prerequisites.sh vps 100.67.210.15 your-username
#   ./scripts/utils/check-prerequisites.sh management 100.67.210.15
###############################################################################
