...
#
# Usage: sudo ./scripts/setup/setup-control-plane-sudo.sh
###############################################################################
...
if [ -n "${SUDO_USER:-}" ]; then
    ...
    log_error "Run as your regular user: ./scripts/setup/setup-control-plane-sudo.sh"
    log_error "Or with sudo: sudo ./scripts/setup/setup-control-plane-sudo.sh"
    exit 1
else
