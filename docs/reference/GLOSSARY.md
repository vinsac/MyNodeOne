...
**When you see:** `sudo ./scripts/installation/install-mynodeone.sh` - you're running with full permissions.
...
- You just need to run `sudo ./scripts/installation/install-mynodeone.sh` and answer questions
