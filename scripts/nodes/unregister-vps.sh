...
#
# Usage: ./scripts/nodes/unregister-vps.sh [vps-tailscale-ip]
#
# Examples:
#   ./scripts/nodes/unregister-vps.sh 100.65.241.25
#   ./scripts/nodes/unregister-vps.sh  # Will auto-detect if run on VPS
###############################################################################
