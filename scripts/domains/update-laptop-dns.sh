...
check_kubectl() {
    if ! command -v kubectl &> /dev/null; then
        ...
        echo ""
        echo "Options:"
        echo "  1. Run setup script: sudo $PROJECT_ROOT/scripts/setup/setup-laptop.sh"
    ...
    if ! kubectl get nodes &>/dev/null; then
        ...
        echo "  1. If management laptop: Run sudo $PROJECT_ROOT/scripts/setup/setup-laptop.sh"
